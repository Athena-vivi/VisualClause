...
-- 4. 删除旧策略（如果存在）
-- ----------------------------------------------------------------------------
DROP POLICY IF EXISTS "vc_allow_anon_select" ON visual_clause_entries;
DROP POLICY IF EXISTS "vc_allow_anon_insert" ON visual_clause_entries;
DROP POLICY IF EXISTS "vc_allow_anon_select_metrics" ON visual_clause_metrics;
DROP POLICY IF EXISTS "vc_allow_anon_upsert_metrics" ON visual_clause_metrics;
